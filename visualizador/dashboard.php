...
<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
        <h3>Historial de Asistencias Reportadas</h3>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="7" style="text-align: center; padding: 2rem; color: var(--text-light);">No hay registros reportados para mostrar.</td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
